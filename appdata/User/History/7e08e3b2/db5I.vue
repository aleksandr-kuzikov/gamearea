        ...
        <div class="animals-grid__viewport">
            <div @mousewheel="onScroll" ref="scrollArea" class="animals-grid__scroll-area">
                <div ref="grid" class="animals-grid__grid">
                    <Animal v-for="animal in animals" :key="animal.name + animal.age"
                        :kind="kinds.find(k => k.kind == animal.kind_name)" @hoverAnimal="hoverAnimal" @leaveAnimal="leaveAnimal"
...
export default {
  components: { Animal },
    ...
    methods: {
        ...
        hoverAnimal(name) {
            this.$emit('hoverAnimal', name)
        },
        leaveAnimal() {
            this.$emit('leaveAnimal')
        }
    },
