        ...
        else if($xml->nodeType == XMLReader::ELEMENT)
        {
            ...
            if($xml->hasAttributes)
            {
                ...
                while($xml->moveToNextAttribute())
                {
					...
					if ($xml->name == 'w:val' && $xml->value == 'Title')
						print("Title " . $xml->name ." = " . $xml->value . "<br>");

					
					if ($xml->name == 'w:val' && $xml->value == 'Subtitle')
						print("Subtitle " . $xml->name ." = " . $xml->value . "<br>");

					
					if ($xml->name == 'w:val' && $xml->value == 'Heading1')
						print("Subtitle " . $xml->name ." = " . $xml->value . "<br>");

					
					if ($xml->name == 'w:val' && $xml->value == 'Heading2')
						print("Subtitle " . $xml->name ." = " . $xml->value . "<br>");
						
					if ($xml->name == 'w:val' && $xml->value == 'Heading3')
						print("Subtitle " . $xml->name ." = " . $xml->value . "<br>");
					
					if ($xml->name == 'w:val' && $xml->value == 'Heading4')
						print("Subtitle " . $xml->name ." = " . $xml->value . "<br>");
						
					if ($xml->name == 'w:val' && $xml->value == 'Heading5')
						print("Subtitle " . $xml->name ." = " . $xml->value . "<br>");

					
					if ($xml->name == 'w:val' && $xml->value == 'Heading6')
						print("Subtitle " . $xml->name ." = " . $xml->value . "<br>");
...
class Upload extends CI_Controller {
	...
	public function index()
	{
        ...
        require_once('./application/BookReader/DocxBookReader.php');

        $eee = new DocxBookReader();
