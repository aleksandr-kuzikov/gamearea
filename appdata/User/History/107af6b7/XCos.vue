        ...
        growUp() {
            ...
            if (this.animalSize < this.maxAnimalSize) {
                ...
                this.growUpInterval = setInterval(() => {
                    ...
                    if (Number.parseFloat(this.$refs.animated.style.width) >= this.maxAnimalSize) {
                        this.$refs.animated.style.width = this.maxAnimalSize + 'px'
                        clearInterval(this.growUpInterval)
                    }
                    this.$refs.animated.style.width = Math.ceil(this.$refs.animated.width + this.growUpInFrame) + 'px'
                }, 100)
            }
        }
    },
