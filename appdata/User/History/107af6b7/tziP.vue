    ...
    methods: {
        ...
        growUp() {
            this.growUpInterval = setInterval(() => {
                console.log(this.$refs.animated.clientWidth)
                if (this.$refs.animated.clientWidth >= this.maxAnimalSize) {
                    this.$refs.animated.clientWidth = this.maxAnimalSize
                    clearInterval(this.growUpInterval)
                }
                this.$refs.animated.clientWidth += this.growUpInSec
            }, 1000)
        }
    },
